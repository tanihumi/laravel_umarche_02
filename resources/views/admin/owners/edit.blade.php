  ...
  <div class="container px-5 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      ...
      <div class=" -m-2">
        ...
        <div class="p-2 w-1/2 mx-auto">
          <div class="relative">
            <label for="email" class="leading-7 text-sm text-gray-600">ショップ</label>
            <div required class="w-full bg-gray-100 bg-opacity-50 rounded   focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $owner->shop->name }}</div>
        ...
        <div class="p-2 w-1/2 mx-auto">
          <div class="relative">
            <label for="passwrod_confirmation" class="leading-7 text-sm text-gray-600">パスワード確認</label>
